<%@ Page Title="" Language="C#" MasterPageFile="~/template/Author.Master" AutoEventWireup="true" CodeBehind="AuthorHome.aspx.cs" Inherits="NewsListing.author.AuthorHome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Repeater ID="NewsRepeater" runat="server" DataSourceID="SqlDataSource1">
        <ItemTemplate>
