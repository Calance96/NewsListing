<%@ Page Title="Register" Language="C#" MasterPageFile="~/template/News.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="NewsListing.Register" UnobtrusiveValidationMode="None" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="width: 60%; margin: 0 auto;">
        <span class="h2 font-weight-bold">Register</span>
        <hr />
        ...
        <asp:Button runat="server" ID="CancelBtn" CausesValidation="false" CssClass="btn btn-danger" Text="Cancel" />
    </div>
</asp:Content>
